export const CONFIG = {
  ...
  TOSSPAYMENT_CLIENT_KEY: process.env.TOSSPAYMENT_CLIENT_KEY,
  TOSSPAYMENT_SECRET_KEY: process.env.TOSSPAYMENT_SECRET_KEY,
  TOSSPAYMENT_SUCCESS_URL: process.env.TOSSPAYMENT_SUCCESS_URL,
  TOSSPAYMENT_FAIL_URL: process.env.TOSSPAYMENT_FAIL_URL,
